...
const AdminStakeholderCertificates = React.lazy(
  () => import('./views/stakeholderCertificates/adminRole/indexOnboarding')
)
...
const routes = [
  ...
  {
    exact: true,
    path: '/Acertificates/onboarding',
    name: 'Admin Onboarding Certificates',
    component: AdminStakeholderCertificates
  },
  {
    exact: true,
    path: '/Acertificates/licences',
    name: 'Admin Licences Certificates',
    component: AdminLicenceCertificates
  },
